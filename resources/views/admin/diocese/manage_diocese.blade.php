     ...
     <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h5 class="page-title">Manage Diocese</h5>
...
{{-- ........add new item........ --}}
      <div class="row add_new_item">
        <div class="col-sm-12">
          <a href="{{url('admin/diocese/create')}}" class="btn btn-info add-new"><i class="fa fa-plus"></i>Add New</a>
        </div>
      </div>
{{-- ........add new item  end........ --}}
  ...
  {{-- ................ --}}
      ...
      <!-- ============================table_data================================== -->
                        <div class="" id="table_data">
                            @include('admin/diocese/manage_diocese_data_load')
                        </div>
        <!-- =========================table_data end=================================== -->
...
$.ajaxSetup({
 ...
 function action_status(id){
    $.ajax({
      url:'{{ URL::asset('/admin/action_status_diocese/')}}',
                  type: 'POST',
                  data: { id: id},
...
<script>
 function delete_item(id){
   ...
   {
    $.ajax({
      url:'{{ URL::asset('/admin/delete_diocese') }}',
                  type: 'POST',
                  data: { id: id },
       success:function(data){
         var page_no=$('#page_no').val();
...
function fetch_data(page)
{
 ...
 $.ajax({
  url:'{{ URL::asset('/admin/manage_donate_data_load/fetch_data?page=') }}'+page,
  type: 'GET',
