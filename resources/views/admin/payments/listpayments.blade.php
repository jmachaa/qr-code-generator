...
@section('title','Payment History – '.e(config('admin_settings.engine_name')))
@section('content')
...
{{--<div class="row add_new_item">
  <div class="col-sm-12">
    <a href="{{url('admin/category/create')}}" class="btn btn-info add-new"><i class="fa fa-plus"></i>Add New</a>
  </div>
</div>--}}
{{-- ........add new item  end........ --}}
  ...
  <div class="col-sm-12 col-md-9 ">
            ...
            <button onclick="fetch_data(1)" class="btn btn-primary"><i class="fa fa-search"></i></button>
                    ...
                    <div class="filter-group select_box">
                      ...
                      {{-- <a href="{{ route('payment.export_data') }}"  class="btn btn-primary"><i class="fa fa-download me-1"></i>Export Data</a> --}}
                    </div>
